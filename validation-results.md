...
| 13 | **flexstart-batch** | **PASS** ✅ | `flexstart-class.yaml`<br>`flexstart-job.yaml` | None | Demonstrates DWS (Dynamic Workload Scheduler) flex-start queuing for batch/training workloads. Job template successfully specifies the `nvidia.com/gpu` toleration. |
